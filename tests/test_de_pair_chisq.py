...
def expected_chisq_pair_statistics(genes):
    ...
    lfc = np.array([-0.9663738 , -0.11287096,  0.87314717, -0.29211294,  1.5682771 ,
                    0.06564265, -0.48216639,  0.,  0.,  0.25464233, 0.10079349,  0., -0.31155113,  
                    0.51109165,  0.00948767, -0.52362636])
